...
from .ntm import NTM
from .controller import LSTMController, create_controller
...
class EncapsulatedNTM(nn.Module):
    ...
    def __init__(self, num_inputs, num_outputs,
        ...
        controller = create_controller(num_inputs, M, num_heads, controller_size, 
                                        controller_layers, controller='FFN')
